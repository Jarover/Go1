...
func (c *Calc) InputString(input string) (interface{}, error) {
	...
	case 2:
		cmd = tokens[1]
		c.a = int64(c.res)
		c.b, err2 = strconv.ParseInt(tokens[0], 10, 64)

	case 3:
		cmd = tokens[2]
		c.a, err1 = strconv.ParseInt(tokens[0], 10, 64)
		c.b, err2 = strconv.ParseInt(tokens[1], 10, 64)
	...
	case float64:
		c.res = res.(float64) // type of i is float64
